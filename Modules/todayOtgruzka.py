import json
from .request_moysklad import addTodayOrders
from .addOrders import addTodayOrdersNow
...
def today_otgruzka(day, next_day) :
    massiv = json.loads(addTodayOrders(day, next_day))
    ...
    for order in range(len(items_almSklad)) :
        addTodayOrdersNow(items_almSklad[order]['name'] , day)
